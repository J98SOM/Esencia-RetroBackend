        ...
        document.getElementById('producto-form').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (!res.ok) {
                    ...
                    document.getElementById('producto-form-error').textContent = (err && (err.message || JSON.stringify(err))) || 'Error al guardar';
                    document.getElementById('producto-form-error').classList.remove('hidden');
                    return;
                }
