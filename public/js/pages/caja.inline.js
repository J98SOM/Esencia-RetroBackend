/* Inlined copy of resources/js/pages/caja.js for reliable serving */

// NOTE: generated by agent - keep in sync with resources/js/pages/caja.js
// Copy contents now:
/*** BEGIN COPIED JS ***/
/* Copied from resources/js/pages/caja.js - keep in sync manually if updated */
/* START FILE */

console.log('caja.inline.js loaded');
...
<div class="ticket">
	...
	<div style="display:flex;justify-content:space-between">
		<div>Vueltas</div><div>${formatCOP(Math.max(((invoice.metodos||[]).reduce((s,m)=>s+(m.valor||0),0) - invoice.total),0))}</div>
	</div>
	...
	<div class="center" style="font-size:11px">Gracias por su compra</div>
		...
		if (printBtn) printBtn.addEventListener('click', () => {
				...
				const invoice = { fecha: new Date().toLocaleString(), items, total, metodos, empresa: (window.COMPANY || {}), numero_orden: (document.getElementById('caja-factura-no')?.value) || (window.NEXT_INVOICE_NO || null) };
